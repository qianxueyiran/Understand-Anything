...
Use native-level terminology appropriate for technical education. Keep code identifiers, file paths, framework/library names, API names, and standard technical keywords in their original language when that preserves accuracy or searchability.
